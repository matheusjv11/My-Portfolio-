    ...
    <AboutSection id="about" className="home">
      <div className="myself__paragraph">
        <Paragraph title="About Me" className="text">
          <p>
            Gratuated in 2021, in <strong>Computer Science</strong> at Federal
            University of Tocantins, I have been working as Software Developer
            since. Focused on <strong>Web Development </strong>
            since 2019, most of the time in Fullstack roles.
          </p>
          <p>
            Currently I live in <strong>Porto Alegre, Brazil</strong>. My family
            is spread throughout the country, which made me love being in
            contact with different cultures.
          </p>
          <p>
            Besides loving music, movies, games and development, I could say
